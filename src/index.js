...
const POST_METHODS = ['sof_call', 'sof_estimateGas', 'sof_sendRawTransaction']
...
async function performFetch(network, req, res, source){
  ...
  if (req.method === 'sof_getBlockByNumber' && rawData === 'Not Found') {
    res.result = null
    return
  }
...
// strips out extra keys that could be rejected by strict nodes like susy
